...
return array(
    ...
    'UserFrosting\\FileAudio' => $baseDir . '/models/database/FileAudio.php',
    'UserFrosting\\FileVideo' => $baseDir . '/models/database/FileVideo.php',
    ...
    'UserFrosting\\RecordUserTask' => $baseDir . '/models/database/RecordUserTask.php',
    'UserFrosting\\SiteSettings' => $baseDir . '/models/database/SiteSettings.php',
    'UserFrosting\\Smt2_browsers' => $baseDir . '/models/database/Smt2_browsers.php',
    'UserFrosting\\Smt2_cache' => $baseDir . '/models/database/Smt2_cache.php',
    'UserFrosting\\Smt2_cms' => $baseDir . '/models/database/Smt2_cms.php',
    'UserFrosting\\Smt2_domains' => $baseDir . '/models/database/Smt2_domains.php',
    'UserFrosting\\Smt2_exts' => $baseDir . '/models/database/Smt2_exts.php',
    'UserFrosting\\Smt2_hypernotes' => $baseDir . '/models/database/Smt2_hypernotes.php',
    'UserFrosting\\Smt2_jsopt' => $baseDir . '/models/database/Smt2_jsopt.php',
    'UserFrosting\\Smt2_os' => $baseDir . '/models/database/Smt2_os.php',
    'UserFrosting\\Smt2_records' => $baseDir . '/models/database/Smt2_records.php',
    'UserFrosting\\StaffEvent' => $baseDir . '/models/database/StaffEvent.php',
    'UserFrosting\\Studio' => $baseDir . '/models/database/Studio.php',
    'UserFrosting\\StudioUser' => $baseDir . '/models/database/StudioUser.php',
    'UserFrosting\\Task' => $baseDir . '/models/database/Task.php',
