...
$table_utAss_studio = new \UserFrosting\DatabaseTable("utAss_studio", [
    "obiettivo",
    "istruzioni",
	"commenti",
    "url",
    ...
    "registra_audio",
    "registra_video",
    "registra_comportamento",
    "somministra_sus",
    "somministra_attrakdiff",
	"flag_completato"
]);

$table_utAss_task = new \UserFrosting\DatabaseTable("utAss_task", [
    "titolo",
    "descrizione",
    "durataMax_ss",
    "url",
...
$table_file_audio = new \UserFrosting\DatabaseTable("file_audio", [
    "task_id",
    "user_id",
    "path"
]);

$table_file_video = new \UserFrosting\DatabaseTable("file_video", [
    "task_id",
    "user_id",
    "path"
]);
...
$table_smt2_browsers = new \UserFrosting\DatabaseTable("smt2_browsers", [
    "name"
]);


$table_smt2_cache = new \UserFrosting\DatabaseTable("smt2_cache", [
    "file",
	"url",
	"layout",
	"title",
...
$table_smt2_cms = new \UserFrosting\DatabaseTable("smt2_cms", [
    "type",
	"name",
	"value",
	"description"
...
$table_smt2_domains = new \UserFrosting\DatabaseTable("smt2_domains", [
    "domain"
]);


$table_smt2_exts = new \UserFrosting\DatabaseTable("smt2_exts", [
    "dir",
	"priority"
]);


$table_smt2_jsopt = new \UserFrosting\DatabaseTable("smt2_jsopt", [
    "type",
	"name",
	"value",
	"description"
...
$table_smt2_os = new \UserFrosting\DatabaseTable("smt2_os", [
    "name"
]);


$table_smt2_records = new \UserFrosting\DatabaseTable("smt2_records", [
    "client_id",
    "cache_id",
    "domain_id",
    "os_id",
...
$table_smt2_hypernotes = new \UserFrosting\DatabaseTable("smt2_hypernotes", [
    "record_id",
    "cuepoint",
    "user_id",
    "hypernote"
...
$table_utAss_as_record_user_task = new \UserFrosting\DatabaseTable("utAss_as_record_user_task", [
    "user_id",
    "task_id",
    "record_id"
]);
...
$table_utAss_as_studio_user = new \UserFrosting\DatabaseTable("utAss_as_studio_user", [
    "studio_id",
    "user_id",
    "flag_completato",
    "data_completato",
...
\UserFrosting\Database::setSchemaTable("utAss_studio", $table_utAss_studio);
\UserFrosting\Database::setSchemaTable("utAss_task", $table_utAss_task);
\UserFrosting\Database::setSchemaTable("file_audio", $table_file_audio);
\UserFrosting\Database::setSchemaTable("file_video", $table_file_video);
\UserFrosting\Database::setSchemaTable("smt2_browsers", $table_smt2_browsers);
\UserFrosting\Database::setSchemaTable("smt2_cache", $table_smt2_cache);
\UserFrosting\Database::setSchemaTable("smt2_cms", $table_smt2_cms);
\UserFrosting\Database::setSchemaTable("smt2_domains", $table_smt2_domains);
\UserFrosting\Database::setSchemaTable("smt2_exts", $table_smt2_exts);
\UserFrosting\Database::setSchemaTable("smt2_hypernotes", $table_smt2_hypernotes);
\UserFrosting\Database::setSchemaTable("smt2_jsopt", $table_smt2_jsopt);
\UserFrosting\Database::setSchemaTable("smt2_os", $table_smt2_os);
\UserFrosting\Database::setSchemaTable("smt2_records", $table_smt2_records);
\UserFrosting\Database::setSchemaTable("utAss_as_record_user_task", $table_utAss_as_record_user_task);
\UserFrosting\Database::setSchemaTable("utAss_as_studio_user", $table_utAss_as_studio_user);
